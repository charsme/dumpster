...
class Cimongo_base
{
    ...
    private function connect()
    {
        $options = array();
        try {
            $this->connection = new MongoClient($this->connection_string, $options); //var_dump($this->connection);
    ...
    private function connection_string()
    {
        ...
        $this->host    = Config::App()->get('mongo_host');
        $this->port = Config::App()->get('mongo_port');
        $this->user = Config::App()->get('mongo_user');
        $this->pass = Config::App()->get('mongo_pass');
        $this->dbname = Config::App()->get('mongo_db');
        $this->query_safety = Config::App()->get('mongo_query_safety');
        $dbhostflag = Config::App()->get('mongo_db_flag');
